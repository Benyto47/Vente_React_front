 ...
 const [pdfCommande, setPdfCommande] = useState(0) ; 
  ...
  const qt_total =
    ...
    const update = () => {
      ...
      console.log("::::: qte client : ", qt_total)
    };
    ...
    const notify = () =>
      toast.success(
        `Le montant de : ${priceTT}  , vous sera retiré de votre compte. veuillez maintenant télécharger le pdf`,
        {
          position: "top-right",
          autoClose: 5000,
                ...
                <tr className="bg-blue-400 text-white">
                  ...
                  <th className="border bg-black text-white  border-slate-200">
                    <div className="flex ps-5 items-center space-x-1">
                      <div>Prix Total : </div>
                      <div className="font-bold italic"> {priceTT}.00 dhs </div>
                    </div>
                  </th>
                </tr>
              </thead>
